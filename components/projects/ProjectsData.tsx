export const projects = [
  ...
  },
  {
    ...
    modalContent: (
      <>
        <p>
          Worked as a front-end developer and created a comprehensive payroll
          service using reactjs, tailwind and js.
        </p>
        <p>
          Designed to meet all your business needs, ensuring that employees are
          paid accurately and on time, every time.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    modalContent: (
      <>
        <p>
          A Landing page for a bar selling cocktails and mocktails. Created
          using tailwind and Reactjs.
        </p>
        <p>
          Worked as a front-end developer for this web application. Built the
          landing page using dynamic and reusable components.
        </p>
      </>
    ),
  },
  {
    ...
    modalContent: (
      <>
        <p>
          Contributed as an Angular Frontend Developer for Reviewnest, an
          empowering platform built for small businesses to gather customer
          insights and reviews.
        </p>
        <p>
          Leveraging UI/UX designs, I helped bring the platform to life and
          enhance user experience.
        </p>
        <p>
          Our team&apos;s efforts aimed at driving business growth and enabling
          data-driven decisions while empowering small businesses without
  ...
  },
  {
    ...
    modalContent: (
      <>
        <p>
          Landing page for a task management app, that helps teams and
          individuals manage tasks, track progress, and stay productive.
        </p>
        <p>
          Cutting through the noise and focusing on what matters. Built using
  ...
  },
  {
    ...
    modalContent: (
      <>
        <p>Your one-stop international freight comparison e-market.</p>
        <p>
          Get instant quotes, simple bookings and easy tracking of your
          shipments.
        </p>
      </>
    ),
